...
public static class PackageProbe
{
    ...
    private static readonly IReadOnlyDictionary<PlatformCapabilityKind, Type> Contracts = new Dictionary<PlatformCapabilityKind, Type>
    {
        ...
        [PlatformCapabilityKind.CreatorFeed] = typeof(ICreatorFeedCapability),
        [PlatformCapabilityKind.CreatorSearch] = typeof(ICreatorSearchCapability),
        [PlatformCapabilityKind.Pages] = typeof(IPlatformPagesCapability),
        [PlatformCapabilityKind.GlobalPages] = typeof(IPlatformGlobalPagesCapability),
        [PlatformCapabilityKind.CreatorProfile] = typeof(ICreatorProfileCapability),
        [PlatformCapabilityKind.CommentReplies] = typeof(ICommentRepliesCapability),
