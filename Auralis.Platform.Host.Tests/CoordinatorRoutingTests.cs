...
hostRequirements = new PlatformHostRequirements { MinimumHostSdkVersion = PlatformHostCompatibility.SdkVersion, RequiredFeatures = ["global-pages.v1", "declarative-pages.v3", "declarative-pages.v4", "declarative-pages.v5", "declarative-pages.v6", "declarative-pages.v7", "declarative-pages.v8", "declarative-pages.v9", "declarative-pages.v2", "declarative-pages.v1", "creator-profile.v1", "comment-artwork.v1", "settings.v1", "track-details.v1", "creator-search.v1", "creator-feed.v1", "comment-replies.v1"] },
