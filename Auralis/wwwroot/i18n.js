(() => {
  ...
  const englishSourceCatalog = Object.freeze({
    '搜索结果优先显示': 'Search result priority',
    '只调整展示顺序，不改变搜索范围或播放队列': 'Changes display order only, not search scope or the playback queue',
    '本地优先': 'Local first',
    '插件优先': 'Plugins first',
    '搜索偏好': 'Search preference',
    '优先展示本地或在线结果；不改变搜索范围或播放队列': 'Show local or online results first; this does not change search scope or the playback queue',
    '在线优先': 'Online first',
    '优先查看在线内容，也可随时浏览本地音乐': 'See online content first, with local music always available',
    '插件结果单独显示，不会被加入本地曲库。': 'Plugin results are shown separately and are not added to the local library.',
    '画质': 'Video quality',
    '自动画质': 'Automatic quality',
    '待导入版本': 'Version to import',
    "选择旧版包": "Choose an older package",
    "版本与声明变化": "Version and declaration changes",
    "首次安装": "First installation",
    "更新插件": "Update plugin",
    "重新导入旧版": "Reimport an older version",
    "重新导入相同版本": "Reimport the same version",
    "旧版本信息不可用": "Previous version information unavailable",
    "当前选择版本": "Currently selected version",
    "当前播放器 SDK": "Current player SDK",
    "清单兼容检查通过；尚未测试登录、网络或播放功能。": "Manifest compatibility passed; login, network and playback have not been tested.",
    "将重新导入所选旧版包。不会自动恢复账号或设置，也不会热替换运行中的插件。": "The selected older package will be reimported. Accounts and settings are not restored automatically; running plugins are not hot-swapped.",
    "旧版本未通过完整性确认；差异仅供参考，不能作为已验证的恢复基线。": "The previous version has not passed integrity verification. Differences are informational, not a verified recovery baseline.",
    "访问声明发生变化，请核对以下新增与移除范围后再确认信任。": "Access declarations changed. Review the added and removed scopes before confirming trust.",
    "提供方标识": "Provider identities",
    "声明能力": "Declared capabilities",
    "页面入口": "Page entries",
    "设置项": "Settings",
    "旧设置兼容访问": "Legacy setting access",
    "图片域名范围": "Artwork domains",
    "新增": "Added",
    "移除": "Removed",
    "未发现所列声明的增删；仍需重新确认信任。": "No additions or removals in these declarations; new trust approval is still required.",
    "这里只比较声明标识和类型，不代表全部代码、权限或设置语义的差异。收藏引用会保留，不自动迁移或删除。": "This compares declaration identifiers and types, not all code, permissions or setting semantics. Saved references are retained, not automatically migrated or deleted.",
    "旧版内容摘要（不是压缩包摘要）": "Previous payload checksum (not the archive checksum)",
    "确认后默认关闭；请明确启用并重启。正在播放的会话不会在导入时切换。": "Imported revisions default to disabled. Explicitly enable and restart; importing does not switch the current playback session.",
    "无法准备旧版包。请选择同一插件 ID、版本更低且兼容的完整包；当前选择也必须通过完整性检查。原选择未改变。": "Could not prepare recovery. Choose a complete compatible package with the same plugin ID and a lower version. The current selection must also pass integrity verification. The selection is unchanged.",
    '查询条件无效，请检查输入后重试。': 'Please check the search text and selected options, then try again.',
    '已达到页面显示上限，请重新打开页面。': 'Page display limit reached. Reopen the page to continue browsing.',
    '图片暂不可用': 'Image temporarily unavailable',
    'UP 主 / 作者': 'Creators',
    '搜索分类': 'Result categories',
    '综合': 'All results',
    '音视频': 'Audio & video',
    '用户': 'Users',
    '查看全部用户': 'View all users',
    '已加载当前可见的作者': 'All currently available creators loaded',
    '没有匹配的作者': 'No matching creators',
    '作者搜索暂不可用': 'Creator search is temporarily unavailable',
    '作者搜索暂不可用，请稍后重试。': 'Creator search is temporarily unavailable. Please try again later.',
    '查看图片': 'View image',
    '图片显示方式': 'Image display mode',
    '适应窗口': 'Fit to window',
    '长图阅读': 'Read tall image',
    '图片阅读区域': 'Image reading area',
    '正在加载图片…': 'Loading image…',
    '转发原文': 'Quoted activity',
    '继续阅读': 'Continue reading',
    '已到本段末尾，继续阅读下一段；可返回当前段。': 'Continue with the next section. You can return to this section.',
    '上一张': 'Previous image',
    '下一张': 'Next image',
    '插件页面': 'Plugin pages',
    '页面分区': 'Page sections',
    '返回': 'Back',
    '读取超时，请重试。': 'The request timed out. Please try again.',
    '无法读取插件页面，请重试。': 'Unable to load this plugin page. Please try again.',
    '插件页面格式不受支持或超出限制。': 'This plugin page is unsupported or exceeds the display limits.',
    '页面入口已过期或插件不可用，请重新打开。': 'This page has expired or the plugin is unavailable. Please reopen it.',
    '暂无内容': 'No content yet',
    '平台未返回有效评论分页，暂不能确认评论是否加载完整。请稍后重试。': 'The provider did not return a valid comment page. Loading is not confirmed complete. Please try again later.',
    '作者主页': 'Creator profile',
    '作者主页暂不可用': 'Creator profile is temporarily unavailable',
    '音乐人请求无效。': 'Invalid artist profile request.',
    '音乐人资料暂不可用。': 'Artist profile is temporarily unavailable.',
    '音乐人资料与当前歌曲不匹配。': 'The artist profile does not match this track.',
    '此歌曲未提供音乐人主页。': 'No artist profile is available for this track.',
    '插件设置或账号已改变，请重新播放。': 'The plugin settings or account changed. Please play the track again.',
    '作者动态': 'Creator activity',
    '动态图片': 'Activity image',
    '图片暂不可用': 'Image unavailable',
    '此动态未提供评论入口': 'Comments are unavailable for this post',
    '暂无可见动态': 'No visible activity',
    '已加载当前可见的动态': 'All currently available activity loaded',
    '仅显示平台允许访问的内容；已删除或受限内容可能不可见。': 'Only content available from the provider is shown. Deleted or restricted content may be unavailable.',
    '已加载当前可见的评论': 'All currently available comments loaded',
    '已加载当前可见的回复': 'All currently available replies loaded',
    '展开回复': 'Show replies',
    '查看回复': 'View replies',
    '评论详情': 'Comment details',
    '返回评论': 'Back to comments',
    ...
    '加载更多': 'Load more',
    '作者筛选': 'Filter by creator',
    '有新动态，点击查看': 'New activity · Click to view',
    '自动检查已暂停，点击重试': 'Update checks paused · Click to retry',
    '展开全文': 'Read more',
    '收起全文': 'Show less',
    ...
    '播放': 'Play',
    '加入队列': 'Add to queue',
    '播放队列已满': 'The play queue is full',
    '已在播放队列中': 'Already in the play queue',
    '已加入播放队列': 'Added to the play queue',
    '当前不可播放': 'Currently unavailable',
    '仅试听': 'Preview only',
    '暂停': 'Pause',
    '下一首': 'Next',
    '播放列表': 'Play queue',
    ...
    '暂无封面': 'No cover available',
    '图片加载失败，点击重试': 'Image unavailable. Click to retry',
    '重试图片': 'Retry image',
    '重试头像': 'Retry avatar',
    '头像加载失败，点击头像或按 R 重试': 'Avatar unavailable. Click the avatar or press R to retry',
