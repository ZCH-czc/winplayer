...
const suites = new Map([
  ...
  ['journey', 'Test-CommunityJourney.cjs'],
  ['loading', 'Test-LoadingStates.cjs'],
  ['profile', 'Test-ProfileSurfaces.cjs'],
  ['motion', 'Test-PageMotion.cjs'],
  ['updates', 'Test-PageUpdates.cjs'],
  ['gallery', 'Test-PageGallery.cjs'],
  ['pages', 'Test-DeclarativePages.cjs'],
  ['pagefeeds', 'Test-PluginPageFeeds.cjs'],
  ['reading', 'Test-PluginReadingWindows.cjs'],
  ['readingv7', 'Test-PluginReadingSurface.cjs'],
  ['readingv8', 'Test-PluginRichReading.cjs'],
  ['discussion', 'Test-DiscussionLifecycle.cjs'],
