...
internal static class PlatformCapabilityMap
{
    private static readonly IReadOnlyDictionary<Type, PlatformCapabilityKind> Types =
        new Dictionary<Type, PlatformCapabilityKind>
        {
            ...
            [typeof(ICreatorSearchCapability)] = PlatformCapabilityKind.CreatorSearch,
            [typeof(IPlatformPagesCapability)] = PlatformCapabilityKind.Pages,
            [typeof(IPlatformGlobalPagesCapability)] = PlatformCapabilityKind.GlobalPages,
            [typeof(ICreatorProfileCapability)] = PlatformCapabilityKind.CreatorProfile,
            [typeof(ICreatorFeedCapability)] = PlatformCapabilityKind.CreatorFeed,
            [typeof(ICommentRepliesCapability)] = PlatformCapabilityKind.CommentReplies,
    ...
    internal static bool Implements(IPlatformProvider provider, PlatformCapabilityKind kind) => kind switch
    {
        ...
        PlatformCapabilityKind.CreatorSearch => provider is ICreatorSearchCapability,
        PlatformCapabilityKind.Pages => provider is IPlatformPagesCapability,
        PlatformCapabilityKind.GlobalPages => provider is IPlatformGlobalPagesCapability,
        PlatformCapabilityKind.CreatorProfile => provider is ICreatorProfileCapability,
        PlatformCapabilityKind.CreatorFeed => provider is ICreatorFeedCapability,
        PlatformCapabilityKind.CommentReplies => provider is ICommentRepliesCapability,
